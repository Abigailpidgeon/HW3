...
switch ($_POST['actionType']){
  case "Add":
   if (insertAppointments($_POST['did'],$_POST['pid'],$_POST['ppatid'],$_POST['aroom'],$_POST['adaytime'])){
  ...
  break;
  case "Edit":
   if (updateAppointments($_POST['did'],$_POST['pid'],$_POST['ppatid'],$_POST['aroom'],$_POST['adaytime'],$_POST['aid'])){
