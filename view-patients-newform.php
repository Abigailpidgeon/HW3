  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="newPatientModalLabel">New Patient</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
  <form method = "post" action="">
    <div class="mb-3">
      <label for="ppatname" class="form-label">Patient name</label>
      <input type="text" class="form-control" id="ppatname" name ="ppatname">
    </div>
    <div class="mb-3">
